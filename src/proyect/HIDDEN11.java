 ...
 * @author SOTO
 */
public class HIDDEN11 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HIDDEN11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
