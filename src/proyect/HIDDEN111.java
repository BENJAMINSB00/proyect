 ...
 * @author SOTO
 */
public class HIDDEN111 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(157, 80, 442, -1));
        ...
        jPanel2.add(PANEL, new org.netbeans.lib.awtextra.AbsoluteConstraints(157, 164, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/wallpaper-quadhd-4.jpg"))); // NOI18N
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(-1, 1, 610, 260));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 610, 260));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HIDDEN111.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
